...
- List files from certain plugin
  - `fisher list free-fisher/fisher`
- List tracked files
  - `fisher list (fisher list)`
- List untracked files
  - `fisher ls-untracked-files`
- completion for `fisher list`
- [idempotent](https://github.com/jorgebucaran/fisher/issues/790#issuecomment-3794399063)
- Better ci
- Our url is easier to remember than jorgebucaran/fisher

## Fixed issues of https://github.com/jorgebucaran/fisher
- https://github.com/jorgebucaran/fisher/issues/770
- https://github.com/jorgebucaran/fisher/issues/790
- https://github.com/jorgebucaran/fisher/issues/823
- https://github.com/jorgebucaran/fisher/pull/746
- https://github.com/jorgebucaran/fisher/pull/798
- https://github.com/jorgebucaran/fisher/pull/799

## Installation


```console
curl -sL https://raw.githubusercontent.com/free-fisher/fisher/fishest/functions/fisher.fish | source && fisher install free-fisher/fisher --overwrite ; fisher ignore jorgebucaran/fisher
```
-----
...
**Notice**: some generated files are unexpected not listed in output, e.g. gazorby/fish-exa
...
**Notice**: some generated files are unexpected listed in output, e.g. gazorby/fish-exa
...
```console
fisher update free-fisher/fisher
```
...
To fix broken fisher inner state, we usually:
```
...
See also https://github.com/free-fisher/awsm.fish
...
[@free-fisher](https://github.com/free-fisher) forked and fixed them.
